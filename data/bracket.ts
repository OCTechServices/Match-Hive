...
export const BRACKET_SEED: Omit<BracketMatch, 'home_team' | 'away_team' | 'home_score' | 'away_score' | 'winner'>[] = [
  ...
  // Official host venues: 11 US cities + Toronto + Vancouver + Mexico City + Guadalajara + Monterrey
  // Slot-to-venue assignment corrected from official FIFA schedule.
  // NOTE: Mexican venues (slots 14-16) and their group-seeding paths need
  // verification against the official FIFA 2026 knockout bracket draw.
  ...
  { id: 'R32-3',  round: 'r32', slot: 3,  date_utc: '2026-06-29T22:00:00Z', venue: 'NRG Stadium',              city: 'Houston',         status: 'upcoming' },
  ...
  { id: 'R32-11', round: 'r32', slot: 11, date_utc: '2026-07-01T22:00:00Z', venue: 'Mercedes-Benz Stadium',    city: 'Atlanta',         status: 'upcoming' },
  ...
  { id: 'R16-3',  round: 'r16', slot: 3,  date_utc: '2026-07-05T18:00:00Z', venue: 'NRG Stadium',              city: 'Houston',         status: 'upcoming' },
  ...
  { id: 'QF-1', round: 'qf', slot: 1, date_utc: '2026-07-09T22:00:00Z', venue: 'Gillette Stadium',          city: 'Foxborough',      status: 'upcoming' },
  { id: 'QF-2', round: 'qf', slot: 2, date_utc: '2026-07-10T22:00:00Z', venue: 'SoFi Stadium',              city: 'Inglewood',       status: 'upcoming' },
  { id: 'QF-3', round: 'qf', slot: 3, date_utc: '2026-07-11T18:00:00Z', venue: 'Hard Rock Stadium',         city: 'Miami Gardens',   status: 'upcoming' },
  { id: 'QF-4', round: 'qf', slot: 4, date_utc: '2026-07-11T22:00:00Z', venue: 'Arrowhead Stadium',         city: 'Kansas City',     status: 'upcoming' },

  // ── SEMI-FINALS (July 14–15) ──
  { id: 'SF-1', round: 'sf', slot: 1, date_utc: '2026-07-14T22:00:00Z', venue: 'AT&T Stadium',             city: 'Arlington',       status: 'upcoming' },
  { id: 'SF-2', round: 'sf', slot: 2, date_utc: '2026-07-15T22:00:00Z', venue: 'Mercedes-Benz Stadium',    city: 'Atlanta',         status: 'upcoming' },

  // ── THIRD PLACE (July 18) ──
  { id: '3RD',   round: '3rd',   slot: 1, date_utc: '2026-07-18T22:00:00Z', venue: 'Hard Rock Stadium',      city: 'Miami Gardens',   status: 'upcoming' },
